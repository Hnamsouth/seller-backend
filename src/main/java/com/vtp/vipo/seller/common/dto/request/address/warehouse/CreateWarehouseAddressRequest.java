...
/**
 * DTO class for creating a warehouse address. This object is used to capture the
 * necessary details for creating a new warehouse address, including fields for
 * the name, phone number, ward ID, street, detailed address, and whether it's the
 * default address for the merchant.
 *
 * <p>This class also performs stripping of leading and trailing whitespace for
 * certain fields to ensure cleaner input data.</p>
 *
 * @see ValidPhoneNumber for phone number validation.
 */
@Getter
@Setter
@FieldDefaults(level = AccessLevel.PRIVATE)
@JsonNaming(PropertyNamingStrategies.SnakeCaseStrategy.class) // Ensures the JSON properties follow snake_case naming strategy
public class CreateWarehouseAddressRequest {
     ...
     */
    @NotBlank(message = "Tên không để được trống")
