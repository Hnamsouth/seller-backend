...
import com.vtp.vipo.seller.config.validation.constraint.IsTrimConstrainValidator;
 ...
 * Date: 9/11/2024
 */
@Constraint(validatedBy = {IsTrimConstrainValidator.class})
@Target({ElementType.FIELD})
@Retention(RetentionPolicy.RUNTIME)
public @interface IsTrim {
    // error message
